 ...
 */
class Dw_opportunities_responses_statusesModelOpportunitiesresponsesstatuses extends JModelList
{
...
if (!JFactory::getUser()->authorise('core.edit.state', 'com_dw_opportunities_responses_statuses'))
{
